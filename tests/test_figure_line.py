...
class ResourceTest(unittest.TestCase):
    ...
    def test_get_line_201_template_ggplot2(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        template=ggplot2
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=ggplot2'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_seaborn(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        template=seaborn
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=seaborn'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_simple_white(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        ...
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=simple_white'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_plotly(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        template=plotly
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=plotly'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_plotly_white(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        ...
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=plotly_white'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_plotly_dark(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        ...
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=plotly_dark'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_presentation(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        ...
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=presentation'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_xgridoff(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        template=xgridoff
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=xgridoff'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_ygridoff(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        template=ygridoff
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=ygridoff'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)

    def test_get_line_201_template_gridon(self):
        """
        GET
        figure/line/test_platform/test_parameter?
        template=gridon
        should return a status_code = 201
        """
        query = 'figure/line/test_platform/test_parameter?template=gridon'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)
    ...
    def test_get_line_201_all(self):
        ...
        query = 'figure/line/test_platform/test_parameter?qc=1&' + \
            ...
            'depth_max=20&depth_min=0&template=presentation'
        response = self.app.get(query, headers={'Authorization': test_token})
        self.assertEqual(201, response.status_code)
